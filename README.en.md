...
Agent-2D-Assets pays tribute to the original [0x0funky/agent-sprite-forge](https://github.com/0x0funky/agent-sprite-forge) project. The initial Codex-oriented 2D sprite and map workflow in this project was inspired by that repository. Agent-2D-Assets builds on that direction with expanded local processors, Godot / Unity handoff docs, the `generate2daudio` skill, multilingual documentation, and example assets. The original copyright notice is preserved in [LICENSE](./LICENSE).
...
Each skill now has 5 copy-ready examples with purpose, prompt, expected outputs, and reproducible commands:
...
Directory: [examples/audio/arcade-platformer-pack](./examples/audio/arcade-platformer-pack)
...
Directory: [examples/audio/sci-fi-combat-pack](./examples/audio/sci-fi-combat-pack)
...
Directory: [examples/audio/cozy-pickup-pack](./examples/audio/cozy-pickup-pack)
